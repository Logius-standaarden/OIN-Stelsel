...
| **00000007** | Instellingscode| De RIO (Registratie Instellingen en Opleidingen) is een register van onderwijsinstellingen dat door DUO wordt beheerd in opdracht van het Ministerie van OCW.|
...
| **00000011** | Dezi-nummer Zorgverzekeraars| Dezi-nummerprefix voor zorgverzekeraars. Het Dezi-register vervangt voor zorgverzekeraars het ZOVAR-register en wordt gebruikt voor identificatie en authenticatie van zowel zorgaanbieders als zorgverzekeraars. |
